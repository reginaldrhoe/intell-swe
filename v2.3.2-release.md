...
Publishing releases with the new PAT token:
```powershell
$env:GITHUB_TOKEN = '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'
